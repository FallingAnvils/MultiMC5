 ...
 */
class MULTISERVERMC_LOGIC_EXPORT BaseInstance : public QObject, public std::enable_shared_from_this<BaseInstance>
{
    Q_OBJECT
protected:
    /// no-touchy!
...
public:
    ...
    /***
     * the instance has been invalidated - it is no longer tracked by MultiServerMC for some reason,
    ...
    /// The instance's ID. The ID SHALL be determined by MSMC internally. The ID IS guaranteed to
    /// be unique.
