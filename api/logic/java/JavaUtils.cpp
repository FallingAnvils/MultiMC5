...
{
    QDir msmcBin(QCoreApplication::applicationDirPath());
...
QProcessEnvironment CleanEnviroment()
{
    ...
    for(auto key: rawenv.keys())
    {
        ...
        // filter MultiServerMC-related things
...
#ifdef Q_OS_LINUX
        // Do not pass LD_* variables to java. They were intended for MultiServerMC
...
QList<QString> JavaUtils::FindJavaPaths()
{
    ...
    // javas stored in MultiServerMC's folder
    scanJavaDir("java");
