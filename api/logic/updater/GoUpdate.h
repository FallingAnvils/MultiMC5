 ...
 */
struct MULTISERVERMC_LOGIC_EXPORT Status
{
 ...
 */
struct MULTISERVERMC_LOGIC_EXPORT FileSource
{
 ...
 */
struct MULTISERVERMC_LOGIC_EXPORT VersionFileEntry
{
    QString path;
    int mode;
 ...
 */
struct MULTISERVERMC_LOGIC_EXPORT Operation
{
 ...
 */
bool MULTISERVERMC_LOGIC_EXPORT parseVersionInfo(const QByteArray &data, VersionFileList& list, QString &error);
 ...
 */
bool MULTISERVERMC_LOGIC_EXPORT processFileLists
(
