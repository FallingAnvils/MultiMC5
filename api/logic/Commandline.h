 ...
 */
MULTISERVERMC_LOGIC_EXPORT QStringList splitArgs(QString args);
 ...
 */
class MULTISERVERMC_LOGIC_EXPORT ParsingError : public std::runtime_error
{
public:
 ...
 */
class MULTISERVERMC_LOGIC_EXPORT Parser
{
public:
    /**
