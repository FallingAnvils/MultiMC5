...
class MULTISERVERMC_LOGIC_EXPORT Path
{
public:
...
struct MULTISERVERMC_LOGIC_EXPORT File
{
    Hash hash;
    bool executable;
    std::uint64_t size = 0;
...
struct MULTISERVERMC_LOGIC_EXPORT Package {
...
struct MULTISERVERMC_LOGIC_EXPORT FileDownload : FileSource
{
...
struct MULTISERVERMC_LOGIC_EXPORT UpdateOperations {
