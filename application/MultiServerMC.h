...
#undef MSMC
#endif
#define MSMC (static_cast<MultiServerMC *>(QCoreApplication::instance()))

class MultiServerMC : public QApplication
{
...
public:
    MultiServerMC(int &argc, char **argv);
    virtual ~MultiServerMC();
...
private:
    ...
    QString m_rootPath;
    Status m_status = MultiServerMC::StartingUp;
    ...
    // peer MultiServerMC instance connector - used to implement single instance MultiServerMC and signalling
